...
public class Persona {
    ...
    public Persona(String text, String text0, String text1, String text2, String text3, String text4, String text5, String text6, String text7) {
...
//    }
    ...
    public String toString() {
        return getCedula()+" "+ getNombre1()+" "+getApellido1()+" "+getFecha()+" "+getTelefono()+" "+getMail()+" "+getPass();}
